...
//     // Previous section mapping - each section-link button points to a specific previous section
...
//     // Add click event listeners to all section-link buttons
//     sectionLinks.forEach((link) => {
//       link.addEventListener("click", () => {
//         // Get the ID of the previous section from our mapping
//         const prevSectionId = prevSectionMap[link.id]

//         if (prevSectionId) {
//           // Find the index of the previous section
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (steps.length) {
    ...
    const prevSectionMap = {
      ...
      installationAddressLink: "dateWorks",
      bookingLink: "installationAddress",
      // Fix for the buttons with different ID patterns
